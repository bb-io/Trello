...
{
    public class TextCustomFieldDataHandler(InvocationContext invocationContext, [ActionParameter] CardRequest input)
    : TrelloInvocable(invocationContext), IAsyncDataSourceHandler
    {
        ...
        CancellationToken cancellationToken)
        {
            ...
            .Where(x => (x.Definition.Type == CustomFieldType.Text ||
                        x.Definition.Type == CustomFieldType.DropDown) &&
